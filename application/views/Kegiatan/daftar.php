                ...
                <div class="card-body">
                  <div class="tab-content" >
                    ...
                    <div class="tab-pane fade show active" >
                        <a href="<?php echo base_url('index.php/Kegiatan/form') ?>">
                            ...
                            echo 
                              "<tr>".
                               "<td>".($i+1)."</td>".
                                ...
                                '<td>
                                    <center>
                                        <a class="btn btn-social-icon btn-danger" href="'.base_url("index.php/Kegiatan/delete/".$out->id_kegiatan).'"><i class="fa fa-remove"></i></a> 
                                        <a class="btn btn-social-icon btn-facebook" href="'.base_url("index.php/Kegiatan/data_edit/".$out->id_kegiatan).'"><i class="fa fa-pencil"></i></a>  
