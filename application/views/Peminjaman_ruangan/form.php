      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <div class="row"> 
            ...
            <form action = "<?php echo base_url('index.php/Peminjaman_ruangan/insert');?>/" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="JK" class="col-sm-4 control-label">Jenis Gedung dan Ruangan yang digunakan</label>
                  <div class="col-sm-7">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="number" class="form-control" name="jumlah_hadir" placeholder="Jumlah Yang Hadir" required/>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="input" class="form-control" name="penanggung_jawab" placeholder="Penanggung Jawab" required/>
                  </div>
                </div>
