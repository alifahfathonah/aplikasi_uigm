                     ...
                     <div class="col-12">
                         <div class="card card-primary card-tabs">
                             <div class="card-body">
                                 ...
                                 <form
                                     action="<?php echo base_url('index.php/Peminjaman_ruangan/edit_perlengkapan/'.$perlengkapan->id_jenis_perlengkapan);?>/"
                                     method="post">
                                     <div class="box-body">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <input type="input" class="form-control" name="jenis_perlengkapan"
                                                     placeholder="Jenis Perlengkapan" value="<?php echo $perlengkapan->jenis_perlengkapan; ?>" required />
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <input type="number" class="form-control" name="jumlah_perlengkapan"
                                                     placeholder="Jumlah Perlengkapan" value="<?php echo $perlengkapan->jumlah_perlengkapan; ?>" required />
                                             </div>
                                         </div>
