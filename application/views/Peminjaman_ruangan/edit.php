                     ...
                     <div class="col-12">
                         <div class="card card-primary card-tabs">
                             <div class="card-body">
                                 ...
                                 <form
                                     action="<?php echo base_url('index.php/Peminjaman_ruangan/edit/'.$pengguna->id_peminjaman_ruangan);?>/"
                                     method="post">
                                     <div class="box-body">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <select class="form-control" name="jenis_kegiatan">
                                                     <option value="<?php echo $pengguna->jenis_kegiatan; ?>">
                                                         <?php echo $pengguna->jenis_kegiatan; ?></option>
                                         ...
                                         <div class="form-group">
                                             <label for="inputNama" class="col-sm-4 control-label">Jenis Gedung dan
                                                 Ruangan yang digunakan</label>

                                             <div class="col-sm-7">
                                                 <select class="form-control" name="jenis_ruangan">
                                                     <option value="<?php echo $pengguna->jenis_ruangan; ?>">
                                                         <?php echo $pengguna->jenis_ruangan; ?></option>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <select class="form-control" name="jenis_perlengkapan">
                                                     <option value="<?php echo $pengguna->jenis_perlengkapan; ?>">
                                                         <?php echo $pengguna->jenis_perlengkapan; ?></option>
                      ...
                      ?>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7 control-label ">
                                                 <input type="time" class="col-sm-4" name="waktu_mulai" required/
                                                     value="<?php echo $pengguna->waktu_mulai; ?>">
                                                 <input type="time" class="col-sm-4" name="waktu_selesai"
                                                     value="<?php echo $pengguna->waktu_selesai; ?>" required />
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <input type="number" class="form-control"
                                                     value="<?php echo $pengguna->jumlah_hadir; ?>" name="jumlah_hadir"
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <input type="input" class="form-control"
                                                     value="<?php echo $pengguna->penanggung_jawab; ?>"
                                                     name="penanggung_jawab" placeholder="Penanggung Jawab" required />
                                             </div>
                                         </div>
                                         ...
                                         <div class="box-footer">
                                             <a href="<?php echo base_url('index.php/Peminjaman_ruangan') ?>">
                                                 <button type="button" class="btn "><i class="fa fa-reply">
                                                         Back</i></button>
                                             </a>
