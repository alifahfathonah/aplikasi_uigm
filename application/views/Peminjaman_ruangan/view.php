                                 ...
                                 <form action="#" method="post">
                                     <div class="box-body">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <label for="inputNama"
                                                     class="form-control"><?php echo $pengguna->nip; ?></label>
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                             <label for="inputNama" class="col-sm-3 control-label">Keperluan
                                                 Ruangan</label>
                                             <div class="col-sm-7">
                                                 <label for="inputNama"
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <label for="inputNama"
                                                     class="form-control"><?php echo $pengguna->jenis_ruangan; ?></label>
                                             </div>
                                         </div>
                                         <div class="form-group">
