                             ...
                             <div class="card-body">
                                 ...
                                 <form action="<?php echo base_url('index.php/Pegawai/insert');?>/" method="post">
                                     <div class="box-body">
                                         ...
                                         <div class="form-group">
                                             <label for="identitas" class="col-sm-3 control-label">No Induk
                                                 Pegawai</label>
                                             <div class="col-sm-7">
                                         ...
                                         <div class="form-group">
                                             <label for="Tempat" class="col-sm-3 control-label fa fa-calendar"> Tanggal
                                                 Lahir</label>
                  ...
                  <div class="col-sm-7">
                    <input type="password" class="form-control" name="password" placeholder="Password">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-7">
                                                 <input type="input" class="form-control" name="no_hp"
                                                     placeholder="No HP">
                                             </div>
