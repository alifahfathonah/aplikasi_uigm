    ...
    <div class="content-page">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          ...
          <form action="<?=base_url('index.php/Prodi/edit/'.$Prodi->id_prodi);?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="keterangan"><?= $Prodi->keterangan ?></textarea>
            </div>
